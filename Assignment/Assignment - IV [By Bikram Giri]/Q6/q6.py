...
img_path = "D:/Digital Pathshala/AI ML With Python/Assignments/Assignment - IV [By Bikram Giri]/img"
static_image_path = os.path.join(img_path, "celebration.jpg")
static_output_path = os.path.join(img_path, "celebration_detected.jpg")
